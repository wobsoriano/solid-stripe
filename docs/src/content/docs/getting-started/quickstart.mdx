...
This example uses [SolidStart API Routes](https://docs.solidjs.com/solid-start/building-your-application/api-routes#api-routes), but feel free to choose the one that best fits your project's needs.
